    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Nova instância de simulação criada, carregando template de parâmetros do mundo simulado
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Combinando o contexto, ferramentas são chamadas automaticamente para organizar entidades e relações no grafo de conhecimento, inicializando os indivíduos e atribuindo comportamentos únicos e memórias baseados em dados reais
          </p>
          ...
          <div v-if="profiles.length > 0" class="stats-grid">
            ...
            <div class="stat-card">
              ...
              <span class="stat-label">Tópicos de interesse associados</span>
            </div>
          </div>
          ...
          <div v-if="profiles.length > 0" class="profiles-preview">
            <div class="preview-header">
              <span class="preview-title">Perfis de Agente Gerados</span>
            </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Gerar Configurações Dual-Plataforma</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            O LLM configura inteligentemente a velocidade do tempo no mundo, algoritmos de recomendação, períodos ativos de cada indivíduo, frequência de publicação e outros parâmetros de acionamento de eventos
          </p>
          ...
          <div v-if="simulationConfig" class="config-detail-panel">
            ...
            <div class="config-block">
              <div class="config-grid">
                <div class="config-item">
                  <span class="config-item-label">Duração Total</span>
                  <span class="config-item-value">{{ simulationConfig.time_config?.total_simulation_hours || '-' }} horas</span>
                </div>
                <div class="config-item">
                  <span class="config-item-label">Duração/Rodada</span>
              ...
              <div class="time-periods">
                ...
                <div class="period-item">
                  <span class="period-label">Vazio</span>
            ...
            <div class="config-block">
              <div class="config-block-header">
                <span class="config-block-title">Configurações dos Agentes</span>
                ...
                >
                  ...
                  <div class="agent-params">
                    <div class="param-group">
                      ...
                      <div class="param-item">
                        <span class="param-label">Comentários/hora</span>
                    ...
                    <div class="param-group">
                      ...
                      <div class="param-item">
                        <span class="param-label">Inclinação Emocional</span>
              ...
              <div class="platforms-grid">
                <div v-if="simulationConfig.twitter_config" class="platform-card">
                  ...
                  <div class="platform-params">
                    <div class="param-row">
                      <span class="param-label">Peso de Recenticidade</span>
                    ...
                    <div class="param-row">
                      <span class="param-label">Intensidade Câmara de Eco</span>
      ...
      <div class="step-card" :class="{ 'active': phase === 3, 'completed': phase > 3 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Orquestração Inicial de Ativação</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            Com base na direção narrativa, gera automaticamente eventos de ativação iniciais e tópicos em alta, guiando o estado inicial do mundo simulado
          </p>
          ...
          <div v-if="simulationConfig?.event_config" class="orchestration-content">
            ...
            <div class="topics-section">
              <span class="box-label">Tópicos Iniciais em Alta</span>
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        ...
        <div class="card-content">
          ...
          <p class="description">Ambiente de simulação pronto. Você pode iniciar a simulação agora.</p>
          ...
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                ...
                <span class="section-desc">MiroFish planeja automaticamente <span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || '-' }}</span> horas da realidade, cada rodada representa <span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || '-' }}</span> minutos do tempo real</span>
              </div>
              ...
              <div v-if="useCustomRounds" class="rounds-content custom" key="custom">
                <div class="slider-display">
                  ...
                  <div class="slider-meta-info">
                    <span>Para 100 Agentes: cerca de {{ Math.round(customMaxRounds * 0.6) }} minutos</span>
                  </div>
                </div>
                  ...
                  <div class="auto-content">
                    <div class="auto-meta-row">
                      <span class="duration-badge">
                        ...
                        Para 100 Agentes: cerca de {{ Math.round(autoGeneratedRounds * 0.6) }} minutos
                      </span>
                    </div>
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">Na primeira execução, recomendamos mudar para 'Personalizado' para reduzir as rodadas e visualizar o resultado rapidamente ➝</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="action-group dual">
            ...
            >
              Iniciar Simulação Paralela Dual-Mundo ➝
            </button>
          </div>
        </div>
      </div>
      ...
      <div v-if="selectedProfile" class="profile-modal-overlay" @click.self="selectedProfile = null">
        ...
        <div class="modal-body">
          ...
          <div class="modal-info-grid">
            <div class="info-item">
              <span class="info-label">Idade Ap. no Evento</span>
              <span class="info-value">{{ selectedProfile.age || '-' }} anos</span>
            </div>
            <div class="info-item">
              <span class="info-label">Gênero Ap. no Evento</span>
            ...
            <div class="info-item">
              <span class="info-label">MBTI Ap. no Evento</span>
          ...
          <div class="modal-section" v-if="selectedProfile.interested_topics?.length">
            <span class="section-label">Tópicos Relacionados a Fatos</span>
          ...
          <div class="modal-section" v-if="selectedProfile.persona">
            ...
            <div class="persona-dimensions">
              <div class="dimension-card">
                ...
                <span class="dim-desc">Trajetória completa de ações no evento</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">Perfil de Comportamento</span>
                <span class="dim-desc">Experiências e preferências de conduta</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">Memórias Únicas</span>
                <span class="dim-desc">Memórias formadas a partir de dados reais</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">Rede de Relações Sociais</span>
                <span class="dim-desc">Grafo de links e interações individuais</span>
              </div>
            </div>
