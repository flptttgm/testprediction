        ...
        <div class="card-files-wrapper">
          ...
          <div class="files-list" v-if="project.files && project.files.length > 0">
            ...
            <div v-if="project.files.length > 3" class="files-more">
              +{{ project.files.length - 3 }} arquivo(s)
            </div>
          </div>
          <!-- 无文件时的占位 -->
        ...
        <div v-if="selectedProject" class="modal-overlay" @click.self="closeModal">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <!-- 文件列表 -->
              <div class="modal-section">
                <div class="modal-label">Arquivos Relacionados</div>
                ...
                <div class="modal-empty" v-else>Nenhum arquivo relacionado</div>
              </div>
            </div>
            ...
            <div class="modal-divider">
              ...
              <span class="divider-text">Retomar Simulação</span>
              <span class="divider-line"></span>
            </div>
            ...
            <div class="modal-playback-hint">
              <span class="hint-text">Step3 «Iniciar Simulação» e Step5 «Interação Profunda» só podem ser iniciados durante a execução e não suportam retomada histórica</span>
            </div>
          </div>
        </div>
      </Transition>
