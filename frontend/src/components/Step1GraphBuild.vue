    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            O LLM analisa o conteúdo do documento e os requisitos de simulação, extrai fatos base e gera automaticamente a estrutura de ontologia adequada
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Com base na ontologia gerada, o documento é fatiado automaticamente e o Zep constrói o grafo de conhecimento, extraindo entidades, relações, memória temporal e resumos de comunidade
          </p>
          ...
          <div class="stats-grid">
            <div class="stat-card">
              ...
              <span class="stat-label">Nós (Entidades)</span>
            </div>
            <div class="stat-card">
              <span class="stat-value">{{ graphStats.edges }}</span>
              <span class="stat-label">Arestas (Relações)</span>
            </div>
            <div class="stat-card">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        ...
        <div class="card-content">
          ...
          <p class="description">Grafo construído com sucesso. Avance para configurar o ambiente de simulação.</p>
          <button 
            class="action-btn" 
...
const handleEnterEnvSetup = async () => {
  if (!props.projectData?.project_id || !props.projectData?.graph_id) {
    console.error('Informações do projeto ou grafo ausentes')
    return
  }
