  ...
  <div class="home-container">
    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          <div class="tag-row">
            <span class="orange-tag">Motor de Inteligência Coletiva Simples e Versátil</span>
            <span class="version-text">/ v0.1-Preview</span>
          </div>
          
          <h1 class="main-title">
            Faça upload de um relatório<br>
            <span class="gradient-text">e preveja o futuro</span>
          </h1>
          
          <div class="hero-desc">
            <p>
              Mesmo com apenas um parágrafo de texto, o <span class="highlight-bold">MiroFish</span> pode usar essas sementes de realidade para gerar automaticamente um mundo paralelo com até <span class="highlight-orange">milhões de Agentes</span>. Injete variáveis com uma visão onisciente e encontre a <span class="highlight-code">“solução local ideal”</span> num fluxo dinâmico em meio a interações coletivas.
            </p>
            <p class="slogan-text">
              Habilite seu futuro para ser ensaiado pelos Agentes, garantindo vitória após cada simulação<span class="blinking-cursor">_</span>
            </p>
          </div>
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <p class="section-desc">
            Motor de previsão em espera, você pode enviar dados não estruturados para inicializar a simulação do sequenciamento
          </p>
          ...
          <div class="metrics-row">
            <div class="metric-card">
              ...
              <div class="metric-label">Média $5/simulação padrão</div>
            </div>
            <div class="metric-card">
              <div class="metric-value">Alta Dispon.</div>
              <div class="metric-label">Suporta até milhões de agentes</div>
            </div>
          </div>
          ...
          <div class="steps-container">
            ...
            <div class="workflow-list">
              <div class="workflow-item">
                ...
                <div class="step-info">
                  <div class="step-title">Construção de Grafo</div>
                  <div class="step-desc">Extração de fatos base & Injeção de memória (indivíduos/grupos) & GraphRAG</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Extração de relação entre entidades & Criação de perfis & Inserção de Agentes e Parâmetros</div>
                </div>
              </div>
              <div class="workflow-item">
                <span class="step-num">03</span>
                <div class="step-info">
                  <div class="step-title">Avaliação e Simulação</div>
                  <div class="step-desc">Simulação paralela em plataforma dupla & Requisitos de previsão automáticos e Atualização temporal</div>
                </div>
              </div>
              <div class="workflow-item">
                <span class="step-num">04</span>
                <div class="step-info">
                  <div class="step-title">Geração de Relatórios</div>
                  <div class="step-desc">O ReportAgent recebe ferramentas abrangentes para profunda interação com o ambiente pós-simulação</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Dialogue com qualquer indivíduo no mundo simulado & Interaja com o ReportAgent</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="console-section">
              ...
              >
                ...
                <div v-if="files.length === 0" class="upload-placeholder">
                  ...
                  <div class="upload-title">Arraste os arquivos aqui</div>
                  <div class="upload-hint">ou clique para adicionar os arquivos</div>
                </div>
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Use linguagem natural para declarar suas necessidades de simulação (Ex. O que aconteceria no mercado se a empresa liberasse o produto com 50% de desconto hoje?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
